...
@Autonomous(name="Auto_Left_Mid_Blue", group="AUTINOMOUSGOOD")
@Config
/**
...
public class Auto_Left_Mid_Blue extends LinearOpMode {
...
//-7.5,-31
        ...
        TrajectorySequence outtake_con3 = drive.trajectorySequenceBuilder(intake_con3.end())
                .splineToLinearHeading(new Pose2d(-14.75,30.25,Math.toRadians(-135)),Math.toRadians(-110),
                        SampleMecanumDrive.getVelocityConstraint(55,225,13.62),
                        SampleMecanumDrive.getAccelerationConstraint(55))
                .addTemporalMarker(0.01, () -> {
                    robot.goMediumSlider();
