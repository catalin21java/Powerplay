...
public class TeleOpDrive extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive() && !isStopRequested()) {
            ...
            telemetry.addData("lf", drive.getPositionLF());
            telemetry.addData("lr", drive.getPositionLR());
            telemetry.addData("rf", drive.getPositionRF());
            telemetry.addData("rr", drive.getPositionRR());
